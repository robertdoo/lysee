...
var
  S: string;
begin
  S := Trim(invoker.paramStr(0));
  if (S <> '') and invoker.paramBool(1) then
    invoker.returnStr(pinyinLong(S, invoker.paramBool(2))) else
    invoker.returnStr(pinyinHead(S));
end;
